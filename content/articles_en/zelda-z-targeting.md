---
title: "Everything 3D Action Games Owe to Zelda's Z-Targeting"
description: "In 1998, Ocarina of Time solved a problem nobody else had cracked: how do you fight in 3D? Z-Targeting was the answer — and almost every 3D action game since is built on it."
topic: "GAME DESIGN"
level: "INTERMEDIATE"
readTime: "8 MIN"
...
# Everything 3D Action Games Owe to Zelda's Z-Targeting
...
![Everything 3D action games owe to Zelda's Z-Targeting](/images/zelda-z-targeting_article/hero.webp)
...
![What lock-on actually fixes: camera, axis and movement reorganize around the target](/images/zelda-z-targeting_article/lock-on-geometry.webp)
**Diagram:** Lock-on creates a fixed reference axis — the camera frames both fighters and your movement becomes strafing

1. **The camera snaps** to frame both you and your target. You can always see the fight.
2. **Link auto-faces the enemy.** Your sword now always swings *at* the thing you're fighting.
3. **Your movement transforms.** Instead of running around blindly, you now strafe and circle around a fixed axis — sidehop left, backflip away, raise your shield to deflect.
...
![The lineage: nearly every 3D action game descends from Z-Targeting](/images/zelda-z-targeting_article/lineage.webp)
**Diagram:** Different names, the same grammar — all descended from a 1998 lock-on
