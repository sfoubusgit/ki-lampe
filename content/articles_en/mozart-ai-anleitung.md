---
title: "MozartAI Tutorial: How to Make Your Own Songs With AI (Step by Step)"
description: "A practical, beginner-friendly guide to MozartAI: how to turn a single idea into a finished song — from Vibe to Studio and Personas, all the way to publishing."
topic: "AI TOOLS"
level: "BEGINNER"
readTime: "11 MIN"
...
Go to [mozartai.com](https://mozartai.com) and create an account. You can sign up with a **phone number (SMS code)**, **Google**, or **Apple**. After signing up, the free plan immediately gives you up to **10 songs** plus access to Mozart Studio.
...
![MozartAI home dashboard with trending songs and top artists](/images/mozart-ai-anleitung_article/mozart-home.webp)
**Screenshot:** The Home view with trending tracks, top artists and the Personas banner

On the left is the **navigation bar** you'll use throughout the app:

- `Vibe` and `Studio` – the two creation modes
- `Personas` – custom sound models
- `Home`, `Library`, `Discover`, `For You` – overview, your content and community
...
![MozartAI Vibe view with lyrics, style description and model selection](/images/mozart-ai-anleitung_article/mozart-vibe-create.webp)
**Screenshot:** The Vibe view — style description, lyrics editor and generation options
...
![MozartAI Project Picker with Vibe and Studio projects](/images/mozart-ai-anleitung_article/mozart-project-picker.webp)
**Screenshot:** The Project Picker — choose between an empty project, a Vibe or a Studio session
...
![MozartAI Studio with timeline, audio and MIDI tracks](/images/mozart-ai-anleitung_article/mozart-studio.webp)
**Screenshot:** Mozart Studio — a timeline with audio and MIDI tracks plus the Clip Agent
...
![MozartAI Personas view with trainable sound models](/images/mozart-ai-anleitung_article/mozart-personas.webp)
**Screenshot:** The Personas gallery — public sound models and "New Persona"

You can:

- create your own model via **"New Persona"**
- browse public personas from other artists (`Public`, `My Personas`, `Liked`)
- apply a persona as a starting point with **"Use Persona"**
...
![MozartAI Library for managing your songs](/images/mozart-ai-anleitung_article/mozart-library.webp)
**Screenshot:** The Library — where your songs, drafts, albums and videos live
...
![MozartAI Discover with top songs, albums and videos](/images/mozart-ai-anleitung_article/mozart-discover.webp)
**Screenshot:** The Discover section with the most popular songs, albums and videos

There's also an active **Discord community** where you can get feedback, ask questions and join contests.

![MozartAI Discord community invite](/images/mozart-ai-anleitung_article/mozart-discord.webp)
**Screenshot:** The Mozart AI community on Discord
...
![MozartAI artist profile with publishing options](/images/mozart-ai-anleitung_article/mozart-profile.webp)
**Screenshot:** The artist profile with "Create Persona," "Edit Profile" and a track overview
...
![MozartAI pricing with Free, Creator, Pro and Premium plans](/images/mozart-ai-anleitung_article/mozart-pricing.webp)
**Screenshot:** The pricing overview — Free, Creator, Pro and Premium
...
No. For Vibe, a written description is enough. The Studio adds depth but is optional.

**Can I use my songs commercially?**
On the paid plans you get full commercial rights according to the provider. Check the terms of service for your specific case.

**What exactly are Personas?**
Custom AI models trained on audio you own (e.g. your voice) to produce a consistent sound.

**Is there an app?**
Yes, MozartAI is also available as an iOS app.
...
> **Want to go from generic tracks to releasable songs?** [**Mozart AI — The Complete Guide: Make, Edit & Sell AI Music**](https://businessflow2.gumroad.com/l/zrfya) is the full playbook: how to prompt MozartAI like a producer, a repeatable formula for song prompts that don't come out generic, how to finish tracks with stems and the Studio, and five realistic ways to actually make money from the music you create.
